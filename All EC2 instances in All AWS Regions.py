...
session = boto3.Session(profile_name = "YOURPROFILENAME", region_name = 'YOURREGIONNAME')
...
for each_region in list_of_aws_regions:
    session = boto3.Session(profile_name = "YOURPROFILENAME", region_name = each_region)
